...
const pages = [
  { id: 1, title: 'Home Page', slug: '/',  status: 'Pubblicata', lastModified: '12/01/2025', name:"home" }
];
            ...
            {pages.map((page) => (
              ...
              >
                ...
                <td className="px-6 py-4">
                  <span className={`px-2.5 py-0.5 rounded-full text-xs font-medium border ${page.status === 'Pubblicata'
                ...
                <td className="px-6 py-4 text-right">
                  <div className="flex justify-end gap-2">
                    ...
                    {/* Modifica */}
                    <Link href={`${pathname}/${page.name}`} className="p-1.5 text-indigo-400 hover:text-indigo-300 hover:bg-indigo-900/30 rounded transition-colors" title="Modifica">
                      <Edit size={16} />
                    </Link>
                  </div>
                </td>
